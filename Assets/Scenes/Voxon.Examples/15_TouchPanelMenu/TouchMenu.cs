...
namespace Voxon.Examples._15_TouchPanelMenu
{
    ...
    public class TouchMenu : MonoBehaviour
    {
        ...
        /* Menu Values */
        /// <summary>
        /// Example of values menu might interact with.
        /// </summary>
        ...
        /// <summary>
        /// Menu enumeration used for action feedback.
        /// Values are developer customisable. Below is an example
        /// of possible actions
        /// </summary>
        public enum MENU
        {
        ...
        /// <summary>
        /// Example menu update callback.
        /// Switches action based on key enumeration
        /// </summary>
        /// <param name="id">ID of action. Used those in <see cref="MENU"/>.</param>
